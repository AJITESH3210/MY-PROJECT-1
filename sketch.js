...
function draw() {
  ...
  if(frameCount === 600){
    ...
    if(mousePressedOver){
      text("You Win", displayWidth-900, displayHeight-850)
    } 
   
    if(mousePressedOver(ball1 || ball2 || ball3 || ball4 || ball5 || ball6 || ball7 || ball8 || ball9 )){
      text("You Lose", displayWidth-900, displayHeight-850);
    }
   */
   }
